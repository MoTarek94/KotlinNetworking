...
class RecyclerViewAdapter (val context: Context, var athletes : List<AthleteDetails>? ):RecyclerView.Adapter<RecyclerViewAdapter.AthleteViewHolder>() {
    ...
    {
            fun bind(athlete:AthleteDetails)
            {
